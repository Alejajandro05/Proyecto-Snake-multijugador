...
import { shouldDieAtWall, getLocalPlayerSpawnPositions } from '../localModeHelpers.js';
...
export class AgainstAIGame extends Phaser.Scene {
    ...
    create() {
        ...
        this.input.keyboard.on('keydown-UP', () => this.pushDirection(P1_ID, 'up'));
        this.input.keyboard.on('keydown-LEFT', () => this.pushDirection(P1_ID, 'left'));
        this.input.keyboard.on('keydown-DOWN', () => this.pushDirection(P1_ID, 'down'));
        this.input.keyboard.on('keydown-RIGHT', () => this.pushDirection(P1_ID, 'right'));
